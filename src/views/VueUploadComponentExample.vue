  ...
  <div>
    ...
    >
      <div
        ...
        :class="{ 'drag-over': $refs.upload && $refs.upload.dropActive }"
        @dragenter.prevent="$refs.upload.dropActive = true"
        @dragleave.prevent="$refs.upload.dropActive = false"
        @dragover.prevent
      >
    ...
    <div class="upload-buttons">
      ...
      <button v-else @click="$refs.upload.active = false" class="stop-button">
        Stop Upload
      </button>
    </div>
